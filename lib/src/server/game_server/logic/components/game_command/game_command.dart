...
class GameCommand {
  ...
  static final _playerCommandStringToGameCommandGenerator = <String, Function>{
    ...
    'set_ahead': (int val) =>
        List.generate(val.abs(), (_) => GameCommand(GameCommandName.ahead, val: 1, isEndOfTurnCommand: true)),
    'back': (int val) => List.generate(val.abs(), (_) => GameCommand(GameCommandName.back, val: 1)),
    'set_back': (int val) =>
        List.generate(val.abs(), (_) => GameCommand(GameCommandName.back, val: 1, isEndOfTurnCommand: true)),
    'rotate_gun': (int val) => List.generate(val.abs(), (_) => GameCommand(GameCommandName.rotateGun, val: 1)),
    'set_rotate_gun': (int val) =>
        List.generate(val.abs(), (_) => GameCommand(GameCommandName.rotateGun, val: 1, isEndOfTurnCommand: true)),
    'rotate_tank': (int val) => List.generate(val.abs(), (_) => GameCommand(GameCommandName.rotateTank, val: 1)),
    'set_rotate_tank': (int val) =>
        List.generate(val.abs(), (_) => GameCommand(GameCommandName.rotateTank, val: 1, isEndOfTurnCommand: true)),
    'rotate_radar': (int val) => List.generate(val.abs(), (_) => GameCommand(GameCommandName.rotateRadar, val: 1)),
    'set_rotate_radar': (int val) =>
        List.generate(val.abs(), (_) => GameCommand(GameCommandName.rotateRadar, val: 1, isEndOfTurnCommand: true)),
